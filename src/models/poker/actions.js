...
export const incrementPot = payload => ({ 
    type: INCREMENT_POT, 
    payload 
});
...
export const decrementPot = payload => ({ 
    type: DECREMENT_POT, 
    payload 
});
...
export const setCardsSelected = (
    winnerCards, 
    playerId
    ) => ({ 
    type: SET_CARDS_SELECTED, 
    payload: { 
        winnerCards, 
        playerId, 
    }, 
